...
%--------------------------------------------------------------------------
    ...
    methods(Access = private)
        ...
        function ResultSave(obj,p,a,r,result,metric)
            ...
            %%%%%%%%%Changed/EDIT by KONG----------
%             filename = fullfile(folder,sprintf('%s_%s_M%d_D%d_N%d_T%d_%d.mat',class(obj.data.ALG(a)),class(obj.data.PRO(p)),obj.data.PRO(p).M,obj.data.PRO(p).D, obj.data.PRO(p).N, obj.data.PRO(p).type, r));
